...
-- PART 3: Keybinds Table
-- Create player keybinds table for storing custom keybinds
...
-- For Supabase environments, this works since auth.users exists
-- For other environments, we rely on the service layer fallback
DO $$
BEGIN
  IF EXISTS (
